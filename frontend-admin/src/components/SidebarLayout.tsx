...
import { LayoutDashboard, HelpCircle, FileText, Users, MessageSquare, Star, Video, Mail, Image, Bell, Menu, Scale, LogOut, ChevronDown, Search, Archive, FolderOpen } from 'lucide-react';
